...
PROMO_CHECKER_COLUMN_MAP = {
    '订单号': ['确认号', '订单号', '预订号', '预定号'], # 操，把所有可能的都加上
    '备注': ['备注', 'Remark', '备注信息'],
    '房类': ['房类', '房型', 'Room Type']
}
...
MEITUAN_SYSTEM_COLUMN_MAP = {
    '预订号': ['预订号', '预定号'], # 操，这个是匹配的关键
    '第三方预定号': ['第三方预定号', '第三方预订号'], # 操，这个也要输出
    '姓名': ['姓名', '名字', '客人姓名', '宾客姓名'],
    '到达': ['到达', '入住日期', '到店日期'],
    '离开': ['离开', '离店日期'],
    '房号': ['房号'],
...
# --- [备注关键字查找] 配置 (操，新加的！) ---
# 这个名字不改了，懒得动config, 反正就是给那个DIY备注查找工具用的
UPGRADE_FINDER_COLUMN_MAP = {
    '预订号': ['预订号', '预定号'],
    '第三方预定号': ['第三方预定号', '第三方预订号'],
    '最近修改人': ['最近修改人', '修改人', 'Last Modifier', '操作员'], # 操，把可能的都写上
    '备注': ['备注', 'Remark', '备注信息']
}
