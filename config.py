...
PROMO_CHECKER_COLUMN_MAP = {
    '订单号': ['确认号', '订单号', '预订号', '预定号'], # 操，这里也可能叫“预定号”
    '备注': ['备注', 'Remark'],
    '房类': ['房类', '房型', 'Room Type']
}
# 操，关键字也写在这里，方便改
PROMO_KEYWORDS = ["早餐1份/天", "金陵吉祥物一只1份"]
PROMO_TARGET_ROOM_TYPE = "JEKN"
...
# --- [美团邮件审核] 配置 ---
# 操，美团这个工具需要知道系统订单里哪些列是啥
MEITUAN_SYSTEM_COLUMN_MAP = {
    '姓名': ['姓名', '名字', '客人姓名', '宾客姓名'],
    '到达': ['到达', '入住日期', '到店日期'],
    '离开': ['离开', '离店日期'],
    '预订号': ['预订号', '预定号'], # JLG 号码对应的是系统里的哪个？这里假设是预订号
    '第三方预定号': ['第三方预定号', '第三方预订号'] # 美团的订单号对应哪个？先放着
}
